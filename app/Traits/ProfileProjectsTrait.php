        ...
        if (isset($user) && count($user->profileProjects)):
            ...
            //   </li>';
              ...
              $html .= '<li class="col-md-6">
                <div class="imgbox">' . $image . '
                  <div class="itemHover">
                    <div class="zoombox"><a target="_blank" href="' . asset('project_images/thumb/'.$project->image) . '" title="' . $project->name . '" class="item-zoom fancybox-effects-a"><i class="fa fa-search" aria-hidden="true"></i></a> </div>
                    <div class="infoItem">
                      <div class="itemtitle">
                        <h5>' . $project->name . '</h5>
                        <p>' . $project->date_start->format('d/m/Y') . ' - ' . $date_end . '<br />
