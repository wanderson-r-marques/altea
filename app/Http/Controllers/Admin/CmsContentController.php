...
class CmsContentController extends Controller
{
    ...
    public function storeCmsContent(CmsContentFormRequest $request)
    {
        ...
        $cmsContent->save();
        flash('Página adicionada com sucesso!')->success();
        ...
        return Datatables::of($cmsContent)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="javascript:void(0);" onclick="delete_cmsContent(' . $cmsContent->id . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Deletar</a>
						</li>																																							
					</ul>
				</div>';
                        })
