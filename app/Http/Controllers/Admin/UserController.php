...
class UserController extends Controller
{
    ...
    public function storeUser(UserFormRequest $request)
    {
        ...
        $user->last_name = 'd '; // $request->input('last_name');
        ...
        flash('Usuário adicionado com!')->success();
    ...
    public function fetchUsersData(Request $request)
    {
        ...
        return Datatables::of($users)
                        ...
                        ->addColumn('action', function ($users) {
                            ...
                            return '
				<div class="btn-group">
					<button class="btn blue dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Ação
					...
					<ul class="dropdown-menu">
						...
						<li>
							<a href="javascript:void(0);" onclick="delete_user(' . $users->id . ');" class=""><i class="fa fa-trash-o" aria-hidden="true"></i>Deletar</a>
						</li>
						<li>
