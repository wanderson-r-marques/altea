...
class AjaxController extends Controller
{
    ...
    public function filterDefaultStates(Request $request)
    {
        ...
        $dd = Form::select('state_id', ['' => __('Selecione o estado')] + $states, $state_id, array('id' => $new_state_id, 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterDefaultCities(Request $request)
    {
        ...
        $dd = Form::select('city_id', ['' => 'Selecione a cidade'] + $cities, $city_id, array('id' => 'city_id', 'class' => 'form-control'));
        echo $dd;
    }
    ...
    public function filterDegreeTypes(Request $request)
    {
        ...
        $dd = Form::select('degree_type_id', ['' => 'Selecione o tipo de diploma'] + $degreeTypes, $degree_type_id, array('id' => 'degree_type_id', 'class' => 'form-control'));
        echo $dd;
    }
