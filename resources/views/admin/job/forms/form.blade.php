...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company_id') !!}" id="company_id_div">
        {!! Form::label('company_id', 'Empresa', ['class' => 'bold']) !!}                    
        {!! Form::select('company_id', ['' => 'Selecione a empresa']+$companies, null, array('class'=>'form-control', 'id'=>'company_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'company_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'title') !!}">
        {!! Form::label('title', 'Cargo', ['class' => 'bold']) !!}
        {!! Form::text('title', null, array('class'=>'form-control', 'id'=>'title', 'placeholder'=>'Cargo')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'title') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'description') !!}">
        {!! Form::label('description', 'Descrição', ['class' => 'bold']) !!}
        {!! Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>'Descrição')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
        ...
        ?>
        {!! Form::select('skills[]', $jobSkills, $skills, array('class'=>'form-control select2-multiple', 'id'=>'skills', 'multiple'=>'multiple', 'placeholder'=>'Selecione as habilidades')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
        ...
        {!! Form::select('country_id', ['' => 'Selecione o pais']+$countries, old('country_id', (isset($job))? $job->country_id:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_freelance') !!}">
        {!! Form::label('is_freelance', 'É Freelance?', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div">
        {!! Form::label('salary_from', 'Salário de', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
        {!! Form::label('salary_to', 'Salário até', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
        ...
        {!! Form::select('salary_currency', ['' => 'Selecione a moeda do salário']+$currencies, null, array('class'=>'form-control', 'id'=>'salary_currency')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
        {!! Form::label('salary_period_id', 'Período de salário', ['class' => 'bold']) !!}                    
        {!! Form::select('salary_period_id', ['' => 'Selecione o período do salário']+$salaryPeriods, null, array('class'=>'form-control', 'id'=>'salary_period_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'salary_period_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'hide_salary') !!}">
        {!! Form::label('hide_salary', 'Esconder o salário?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
            $hide_salary_1 = '';
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
        {!! Form::label('functional_area_id', 'Tipo de empresa', ['class' => 'bold']) !!}                    
        {!! Form::select('functional_area_id', ['' => 'Selecione o tipo de empresa']+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'functional_area_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
        {!! Form::label('job_type_id', 'Tipo de contratação', ['class' => 'bold']) !!}                    
        {!! Form::select('job_type_id', ['' => 'Selecione o tipo de contratação']+$jobTypes, null, array('class'=>'form-control', 'id'=>'job_type_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
        ...
        {!! Form::select('job_shift_id', ['' => 'Selecione o turno']+$jobShifts, null, array('class'=>'form-control', 'id'=>'job_shift_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
        {!! Form::label('num_of_positions', 'Quantidade de vagas', ['class' => 'bold']) !!}                    
        {!! Form::select('num_of_positions', ['' => 'Selecione a quantidade de vagas']+MiscHelper::getNumPositions(), null, array('class'=>'form-control', 'id'=>'num_of_positions')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div">
        ...
        {!! Form::select('gender_id', ['' => __('Sem preferência')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'gender_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
        {!! Form::label('expiry_date', 'Data de exppiração', ['class' => 'bold']) !!}
        {!! Form::text('expiry_date', null, array('class'=>'form-control datepicker', 'id'=>'expiry_date', 'placeholder'=>'Selecione a data de expiração', 'autocomplete'=>'off')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        {!! Form::label('degree_level_id', 'Escolaridade requerida', ['class' => 'bold']) !!}                    
        {!! Form::select('degree_level_id', ['' => 'Selecione a escolaridade requerida']+$degreeLevels, null, array('class'=>'form-control', 'id'=>'degree_level_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
        {!! Form::label('job_experience_id', 'Experiência requerida', ['class' => 'bold']) !!}                    
        {!! Form::select('job_experience_id', ['' => 'Selecione a experiência requerida']+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')) !!}
    ...
    <div class="form-actions">
        {!! Form::button('Criar vaga <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>', array('class'=>'btn btn-large btn-primary', 'type'=>'submit')) !!}
    </div>
</div>
@push('css')
<style type="text/css">
