    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.users') }}">{{__('Users')}}</a> <i class="fa fa-circle"></i> </li>
                <li> <span>{{__('Add User')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span class="caption-subject bold uppercase">{{__('Users Form')}}</span> </div>
                    </div>
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="active"> <a href="#Details" data-toggle="tab" aria-expanded="false"> {{__('Details')}} </a> </li>
                            <li><a href="#Summary" data-toggle="tab" aria-expanded="false">{{__('Summary')}}</a></li>
                            <li><a href="#CV" data-toggle="tab" aria-expanded="false">{{__('C.V')}}</a></li>
                            <li><a href="#Projects" data-toggle="tab" aria-expanded="false">{{__('Projects')}}</a></li>
                            <li><a href="#Experience" data-toggle="tab" aria-expanded="false">{{__('Experience')}}</a></li>
                            <li><a href="#Education" data-toggle="tab" aria-expanded="false">{{__('Education')}}</a></li>
                            <li><a href="#Skills" data-toggle="tab" aria-expanded="false">{{__('Skills')}}</a></li>
                            <li><a href="#Languages" data-toggle="tab" aria-expanded="false">{{__('Languages')}}</a></li>
