<div class="modal-body">
    <div class="form-body">
        <div class="form-group" id="div_name">
            <label for="name" class="bold">{{__('Project Name')}}</label>
        ...
        <div class="form-group" id="div_url">
            <label for="url" class="bold">{{__('Project URL')}}</label>
        ...
        <div class="form-group" id="div_date_start">
            <label for="date_start" class="bold">{{__('Project Start Date')}}</label>
        ...
        <div class="form-group" id="div_date_end">
            <label for="date_end" class="bold">{{__('Project End Date')}}</label>
        ...
        <div class="form-group" id="div_is_on_going">
            <label for="is_on_going" class="bold">{{__('Currently Ongoing?')}}</label>
            <div class="radio-list" style="margin-left:22px;">
                ...
                ?>
                <label class="radio-inline"><input id="not_on_going" name="is_on_going" type="radio" value="0" {{$val_2_checked}}> {{__('Autistic')}} </label>
                <label class="radio-inline"><input id="on_going" name="is_on_going" type="radio" value="1" {{$val_1_checked}}> {{__('Responsible')}} </label>
        ...
        <div class="form-group" id="div_description">
            <label for="name" class="bold">{{__('Project Description')}}</label>
