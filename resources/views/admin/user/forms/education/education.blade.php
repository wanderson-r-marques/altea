...
<div class="form-body">
    <div class="form-group">
        <button class="btn purple btn-outline sbold" onclick="showProfileEducationModal();"> {{__('Add Education')}} </button>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption"> <i class=" icon-layers font-green"></i> <span class="caption-subject font-green bold uppercase">{{__('Education')}}</span> </div>
                </div>
...
<script type="text/javascript">
    ...
    placeholder: "Selecione os assuntos principais",
            allowClear: true
    });
    }
