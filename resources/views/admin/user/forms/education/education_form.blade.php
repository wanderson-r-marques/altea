<div class="modal-body">
    <div class="form-body">
        <div class="form-group" id="div_degree_level_id">
            <label for="degree_level_id" class="bold">{{__('Degree Level')}}</label>
            <?php
            $degree_level_id = (isset($profileEducation) ? $profileEducation->degree_level_id : null);
            ?>
            {!! Form::select('degree_level_id', [''=>'Selecione o nível de escolaridade']+$degreeLevels, $degree_level_id, array('class'=>'form-control', 'id'=>'degree_level_id')) !!}
            <span class="help-block degree_level_id-error"></span> </div>


        <div class="form-group" id="div_degree_type_id">
            <label for="degree_type_id" class="bold">{{__('Degree Type')}}</label>
            <?php
            $degree_type_id = (isset($profileEducation) ? $profileEducation->degree_type_id : null);
            ?>
            <span id="degree_types_dd">
                {!! Form::select('degree_type_id', [''=>'Selecione o curso'], $degree_type_id, array('class'=>'form-control', 'id'=>'degree_type_id')) !!}
            </span>
            <span class="help-block degree_type_id-error"></span> </div>

        <div class="form-group" id="div_degree_title">
            <label for="degree_title" class="bold">{{__('Degree Title')}}</label>
        ...
        <div class="form-group" id="div_major_subjects">
            <label for="degree_major_subjects" class="bold">{{__('Major Subjects')}}</label>
            <?php
        ...
        <div class="form-group" id="div_country_id">
            <label for="country_id" class="bold">{{__('Country')}}</label>
            <?php
        ...
        <div class="form-group" id="div_state_id">
            <label for="state_id" class="bold">{{__('State')}}</label>
            <span id="default_state_education_dd">
                {!! Form::select('state_id', [''=>'Selecione o estado'], null, array('class'=>'form-control', 'id'=>'education_state_id')) !!}
            </span>
            <span class="help-block state_id-error"></span> </div>

        <div class="form-group" id="div_city_id">
            <label for="city_id" class="bold">{{__('City')}}</label>
        ...
        <div class="form-group" id="div_institution">
            <label for="institution" class="bold">{{__('Institution')}}</label>
        ...
        <div class="form-group" id="div_date_completion">
            <label for="date_completion" class="bold">{{__('Completion Year')}}</label>
            <?php
            $date_completion = (isset($profileEducation) ? $profileEducation->date_completion : null);
            ?>
            {!! Form::select('date_completion', [''=>'Selecionar ano']+MiscHelper::getEstablishedIn(), $date_completion, array('class'=>'form-control', 'id'=>'date_completion')) !!}
            <span class="help-block date_completion-error"></span> </div>


        <div class="form-group" id="div_degree_result">
            <label for="degree_result" class="bold">{{__('Degree Result')}}</label>
        ...
        <div class="form-group" id="div_result_type_id">
            <label for="result_type_id" class="bold">{{__('Result Type')}}</label>
            <?php
            $result_type_id = (isset($profileEducation) ? $profileEducation->result_type_id : null);
            ?>
            {!! Form::select('result_type_id', [''=>'Selecione o tipo do resultado']+$resultTypes, $result_type_id, array('class'=>'form-control', 'id'=>'result_type_id')) !!}
