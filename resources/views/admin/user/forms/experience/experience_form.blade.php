<div class="modal-body">
    <div class="form-body">
        <div class="form-group" id="div_title">
            <label for="title" class="bold">{{__('Experience Title')}}</label>
        ...
        <div class="form-group" id="div_company">
            <label for="company" class="bold">{{__('Company')}}</label>
        ...
        <div class="form-group" id="div_country_id">
            ...
            ?>
            {!! Form::select('country_id', [''=>'Selecione o pais']+$countries, $country_id, array('class'=>'form-control', 'id'=>'experience_country_id')) !!}
        ...
        <div class="form-group" id="div_state_id">
            ...
            <span id="default_state_experience_dd">
                {!! Form::select('state_id', [''=>'Selecione o estado'], null, array('class'=>'form-control', 'id'=>'experience_state_id')) !!}
            </span>
        ...
        <div class="form-group" id="div_date_start">
            <label for="date_start" class="bold">{{__('Experience Start Date')}}</label>
        ...
        <div class="form-group" id="div_date_end">
            <label for="date_end" class="bold">{{__('Experience End Date')}}</label>
        ...
        <div class="form-group" id="div_description">
            <label for="name" class="bold">{{__('Experience Description')}}</label>
