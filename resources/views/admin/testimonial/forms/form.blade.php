...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'testimonial_by') !!}">
        {!! Form::label('testimonial_by', 'Depoimento de', ['class' => 'bold']) !!}
        {!! Form::text('testimonial_by', null, array('class'=>'form-control', 'id'=>'testimonial_by', 'placeholder'=>'Depoimento de', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'testimonial_by') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'testimonial') !!}">
        {!! Form::label('testimonial', 'Depoimento', ['class' => 'bold']) !!}
        {!! Form::textarea('testimonial', null, array('class'=>'form-control', 'id'=>'testimonial', 'placeholder'=>'Depoimento', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'testimonial') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company') !!}">
        {!! Form::label('company', 'Empresa e Designação', ['class' => 'bold']) !!}
        {!! Form::text('company', null, array('class'=>'form-control', 'id'=>'company', 'placeholder'=>'Empresa e Designação', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_active') !!}">
        {!! Form::label('is_active', 'Esta ativo?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
