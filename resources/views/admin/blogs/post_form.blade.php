    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            ...
            <ul class="page-breadcrumb">
                ...
                <li> <a>{{__('Add Blog')}}</a> <i class="fa fa-circle"></i> </li>
        ...
        <h3 class="page-title">{{__('Add New Post')}} </h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <div class="alert alert-success alert-dismissible fade show d-flex align-items-center"
                                ...
                                <i class="mdi mdi-checkbox-marked-circle font-32"></i><strong class="pr-1">{{__('Success!')}}</strong>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="control-label" for="lang">{{__('Select Language')}}</label>
                                                            ...
                                                            <div class="blogboxint">
                                                                ...
                                                                <div id="div_show_seo_fields">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="control-label" for="title">{{__('Meta Title')}}</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="control-label" for="title">{{__('Meta Keywords')}}</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="control-label" for="title">{{__('Meta Description')}}</label>
                                                            ...
                                                            <div class="blogboxint">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label"
                                                                        ...
                                                                        for="Upload Image">{{__('Featured Image')}}</label>
