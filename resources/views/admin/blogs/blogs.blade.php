                        ...
                        <div class="panel-heading">
                            ...
                            <ul class="breadcrumb">
                                <li class="active"><a href="{{ URL::asset('/admin/blog')}}"><i
                                            class="fa fa-dashboard"></i> {{__('Manage Blogs')}}</a></li>
                                <li><a href="{{ URL::asset('/admin/blog_category')}}"><i class="fa fa-file-text-o"></i>
                                        {{__('Manage Categories')}}</a></li>
                    ...
                    <div class="modal-content">
                        <form method="POST" files="true" action="{{ asset('admin/blog/create')}}"
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">{{__('Add Blog')}}</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="title">{{__('Select Category')}}</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="title">{{__('Title')}}</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="Slug">{{__('Slug')}}</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="content">{{__('Content')}}</label>
                                    <div class="col-sm-12">
                                ...
                                <br /><br /><br /> <br />
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="Upload Image">{{__('Featured Image')}}</label>
                                    <div class="col-sm-12">
                                ...
                                <div id="div_show_seo_fields" style="display: none">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="title">{{__('Meta Title')}}</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="title">{{__('Meta Keywords')}}</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="title">{{__('Meta Description')}}</label>
                                        <div class="col-sm-12">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" value="{{__('Close')}}" class="btn btn-warning" data-dismiss="modal">
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST" files="true" action="{{ asset('/admin/blog')}}"
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">{{__('Update Blog')}}</h4>
            ...
            <div id="viewModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">{{__('Content')}}</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
