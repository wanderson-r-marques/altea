    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.cmsContent') }}">{{__('C.M.S Content')}}</a> <i class="fa fa-circle"></i> </li>
                <li> <span>{{__('Add C.M.S Content')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span class="caption-subject bold uppercase">{{__('C.M.S Content Form')}}</span> </div>
                    </div>
