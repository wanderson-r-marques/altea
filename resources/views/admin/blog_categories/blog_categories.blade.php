                ...
                <div class="col-lg-12">
                    <section class="content-header">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-md-offset-1">
                                    ...
                                    <button class="add-modal" class="btn btn-primary"
                                        onclick="load_blog_category_add_form ()">{{__('Add new Category')}}</button>
                            ...
                            <ul class="breadcrumb">
                                <ul class="breadcrumb">
                                    <li><a href="{{ URL::asset('/admin/blog')}}"><i class="fa fa-dashboard"></i> {{__('Manage Blogs')}}</a>
                                    </li>
                                    <li class="active"><a href="{{ URL::asset('/admin/blog_category')}}"><i
                                                class="fa fa-file-text-o"></i> {{__('Manage Categories')}}</a></li>
