...
<div class="form-body">
    <h3>{{__('Drag and Drop to Sort the Questions')}}</h3>
    {!! Form::select('lang', ['' => 'Selecione o idioma']+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refresh_faq_sort_data();')) !!}	
