...
<div class="form-body">
    <h3>{{__('Drag and Drop to Sort Sliders')}}</h3>
    {!! Form::select('lang', ['' => 'Selecione o idioma']+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshSliderSortData();')) !!}
