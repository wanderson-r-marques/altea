                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
							...
							@else
							<li class="nav-item"><a href="{{route('job.list')}}" class="nav-link">{{__('Jobs')}}</a> </li>
							@endif

							<li class="nav-item {{ Request::url()}}"><a href="{{route('company.listing')}}" class="nav-link">{{__('Companies')}}</a> </li>
