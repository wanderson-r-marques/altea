...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="https://github.com/wanderson-r-marques/" target="_blank">Wanderson R Marques</a></div>
            </div>
            <div class="col-md-4">
