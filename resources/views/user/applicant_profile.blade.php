    ...
    <div class="container">  
        ...
        <div class="job-header">
            <div class="jobinfo">
                        ...
                        <div class="candidateinfo">
                            ...
                            <div class="title">
                                ...
                                <br><sup style="font-size:12px; color:#090;">{{__('Immediate Available For Work')}}</sup>
                                @endif
                            </div>
            ...
            <div class="jobButtons">
                ...
                @if(null !== $profileCv)<a target="_blank" href="{{asset('cvs/'.$profileCv->cv_file)}}" class="btn"><i class="fa fa-download" aria-hidden="true"></i> {{__('Download CV')}}</a>@endif
                    ...
                    <div class="jobdetail">
                        ...
                        <ul class="jbdetail">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{((bool)$user->verified)? 'Sim':'Não'}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">{{__('Immediate Available')}}</div>
                                <div class="col-md-6 col-xs-6"><span>{{((bool)$user->is_immediate_available)? 'Sim':'Não'}}</span></div>
                            </li>

                            <li class="row">
                                <div class="col-md-6 col-xs-6">{{__('Age')}}</div>
                                <div class="col-md-6 col-xs-6"><span>{{$user->getAge()}} Anos</span></div>
                            </li>
                            <li class="row">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span class="permanent">{{($user->salary_currency == 'BRL') ? 'R$' : $user->salary_currency}} {{  number_format($user->current_salary, 2, ',', '.') }}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-6 col-xs-6">{{__('Expected Salary')}}</div>
                                <div class="col-md-6 col-xs-6"><span class="freelance">{{($user->salary_currency == 'BRL') ? 'R$' : $user->salary_currency}} {{  number_format($user->expected_salary, 2, ',', '.') }}</span></div>
                            </li>              
                        </ul>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function send_message() {
        ...
        el.innerHTML = "Por favor, <a class='btn' href='{{route('login')}}' onclick='set_session()'>faça login</a> e tente novamente."
