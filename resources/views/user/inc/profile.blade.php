...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'father_name') !!}">
			...
			{!! Form::text('father_name', null, array('class'=>'form-control', 'id'=>'father_name', 'placeholder'=>__('Nome do pai'))) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}">
			...
			{!! Form::select('gender_id', [''=>__('Selecione o sexo')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
			...
			{!! Form::select('marital_status_id', [''=>__('Selecione o estado civil')]+$maritalStatuses, null, array('class'=>'form-control', 'id'=>'marital_status_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
            ...
            {!! Form::select('country_id', [''=>__('Selecione o pais')]+$countries, $country_id, array('class'=>'form-control', 'id'=>'country_id')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'country_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
			<label for="">{{__('State')}}</label>
			<span id="state_dd"> {!! Form::select('state_id', [''=>__('Selecione o estado')], null, array('class'=>'form-control', 'id'=>'state_id')) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'state_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
			<label for="">{{__('City')}}</label>
			<span id="city_dd"> {!! Form::select('city_id', [''=>__('Selecione a cidade')], null, array('class'=>'form-control', 'id'=>'city_id')) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'city_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
			<label for="">{{__('Nationality')}}</label>
			{!! Form::select('nationality_id', [''=>__('Selecione a nacionalidade')]+$nationalities, null, array('class'=>'form-control', 'id'=>'nationality_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
			...
			{!! Form::date('date_of_birth', null, array('class'=>'form-control data', 'id'=>'date_of_birth', 'placeholder'=>__('Data de nascimento'), 'autocomplete'=>'off')) !!}
...
<div class="row">
 <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
			...
			{!! Form::select('job_experience_id', [''=>__('Selecione o tempo de experiência')]+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}">
			...
			{!! Form::select('career_level_id', [''=>__('Selecione o seu nível de carreira')]+$careerLevels, null, array('class'=>'form-control', 'id'=>'career_level_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}">
			...
			{!! Form::select('functional_area_id', [''=>__('Selecione o tipo de empresa')]+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area_id')) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
			...
			{!! Form::text('current_salary', null, array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>__('Salário atual'))) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
			...
			{!! Form::text('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('Salário pretendido'))) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
            ...
            @endphp
            {!! Form::text('salary_currency', $salary_currency, array('class'=>'form-control', 'id'=>'salary_currency', 'placeholder'=>__('Salário pretendido'), 'autocomplete'=>'off')) !!}
...
<!-- TEMP SOLUTIONS FOR DATE BR -->
@if($user->date_of_birth)
<script>
        $(function(){
            $('.data').val("{{date('Y-m-d',strtotime($user->date_of_birth))}}");
        });       
</script>
@endif
