<div class="modal-body">
    <div class="form-body">
        ...
        <div class="formrow" id="div_date_start">
            <input class="form-control" id="date_start" placeholder="{{__('Project Start Date')}}" name="date_start" type="date" autocomplete="off" value="{{(isset($profileProject)? $profileProject->date_start:'')}}">
            <span class="help-block date_start-error"></span> </div>
        <div class="formrow" id="div_date_end">
            <input class="form-control" autocomplete="off" id="date_end" placeholder="{{__('Project End Date')}}" name="date_end" type="date" value="{{(isset($profileProject)? $profileProject->date_end:'')}}">
