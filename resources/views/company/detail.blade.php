                    ...
                    <div class="jobdetail">
                        ...
                        <ul class="jbdetail">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{((bool)$company->verified)? 'Sim':'Não'}}</span>
...
function send_message() {
    ...
    el.innerHTML =
        ...
        "Por favor, faça <a class='btn btn-success' href='{{route('login')}}' onclick='set_session()'>login</a> como candidato e tente novamente."
