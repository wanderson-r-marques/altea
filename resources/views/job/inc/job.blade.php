...
<div class="row">  
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div"> {!! Form::select('gender_id', ['' => __('Sem preferência')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
