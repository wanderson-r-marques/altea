                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="minsalary">{{($job_application->salary_currency == 'BRL') ? 'R$' : $job_application->salary_currency}} {{number_format($job_application->expected_salary,2,',','.') }}  <span>/ {{$job->getSalaryPeriod('salary_period')}}</span></div>
                                </div>
