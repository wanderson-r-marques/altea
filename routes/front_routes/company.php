...
Route::get('empresas', 'Company\CompaniesController@company_listing')->name('company.listing');
...
Route::get('empresa/{slug}', 'Company\CompanyController@companyDetail')->name('company.detail');
