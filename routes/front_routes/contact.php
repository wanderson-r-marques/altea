...
Route::get('denunciar-empresa/{company_slug}', 'ContactController@reportAbuseCompany')->name('report.abuse.company');
Route::post('denunciar-empresa/{company_slug}', 'ContactController@reportAbuseCompanyPost')->name('report.abuse.company');
